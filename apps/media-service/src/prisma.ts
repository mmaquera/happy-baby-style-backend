/**
 * Media-service local Prisma singleton.
 *
 * This is the ONLY file in media-service that imports from './generated/prisma'.
...
declare global {
  ...
  var __media_prisma: PrismaClient | undefined;
}
...
function buildPrismaClient(): PrismaClient {
  ...
  if (!global.__media_prisma) {
    global.__media_prisma = new PrismaClient({
      log: ['query', 'info', 'warn', 'error'],
      datasources: { db: { url: dbUrl } },
    });
  }
  return global.__media_prisma;
}
