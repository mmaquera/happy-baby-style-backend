...
export class RateLimitService implements IRateLimitService {
  ...
  private readonly requestCounts: Map<string, { count: number; resetTime: Date; blockedUntil?: Date }> = new Map();
  ...
  private async recordRateLimitEvent(key: string, endpoint: string, eventType: RateLimitEventType): Promise<void> {
